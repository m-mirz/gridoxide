...
#[test]
fn test_pgm_sym_gen() {
    let base = data_dir("symmetric/sym_gen");
...
#[test]
fn test_pgm_asym_sym_gen() {
    let base = data_dir("asymmetric/sym_gen");
    let input = common::load_pgm_input(&base.join("input.json"));
...
#[test]
fn test_pgm_asym_gen() {
    let base = data_dir("asymmetric/asym_gen");
    let input = common::load_pgm_input(&base.join("input.json"));
    let expected = common::load_output(&base.join("asym_output.json"));
