...
Feature: gridoxide against powsybl-open-rao's own expectations
  ...
  Scenario: 5.2.1.2  [5_special_features/5_2_mnec/5_2_1_linear_rao.feature]: margin on MNEC should stay positive (initial margin > 50MW)
  ...
  @fast @rao @dc @preventive-only @mnec @max-min-margin
  Scenario: 5.2.1.3  [5_special_features/5_2_mnec/5_2_1_linear_rao.feature]: margin on MNEC should stay above initial value -50 MW [1] (initial margin < 0MW)
  ...
  @fast @rao @dc @preventive-only @mnec @max-min-margin
  Scenario: 5.2.1.4  [5_special_features/5_2_mnec/5_2_1_linear_rao.feature]: margin on MNEC should stay above initial value -50 MW [2] (50MW > initial margin > 0MW)
