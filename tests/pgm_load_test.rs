...
#[test]
fn test_pgm_sym_load() {
    let base = data_dir("symmetric/sym_load");
...
#[test]
fn test_pgm_asym_sym_load() {
    let base = data_dir("asymmetric/sym_load");
    let input = common::load_pgm_input(&base.join("input.json"));
...
#[test]
fn test_pgm_asym_load() {
    let base = data_dir("asymmetric/asym_load");
    let input = common::load_pgm_input(&base.join("input.json"));
    let expected = common::load_output(&base.join("asym_output.json"));
